...
\begin{figure}[h!]
\centering
\subfloat[a part of ground sharp images]{\includegraphics[width = 1\textwidth]{pic/synthetic_blurry_images.png}}
\hspace{\fill}
\subfloat[kernels]{\includegraphics[width = 1\textwidth]{pic/synthetic_kernels.png}}
\hspace{\fill}
...
\begin{figure}[h!]
\centering
\subfloat[blurred image and kernel]{\includegraphics[width = 0.24\textwidth]{pic/synthetic/blurred.png}}
\hspace{\fill}
\subfloat[$L_0$ \cite{xu2013unnatural}]{\includegraphics[width = 0.24\textwidth]{pic/synthetic/L0.png}}
\hspace{\fill}
\subfloat[$L_1$]{\includegraphics[width = 0.24\textwidth]{pic/synthetic/L1.png}}
\hspace{\fill}
\subfloat[$L_0$ IRL1]{\includegraphics[width = 0.24\textwidth]{pic/synthetic/L0_IRL1.png}}
\hspace{\fill}
\caption{Example Deblurred Images (Synthetic Dataset)}
\label{fig:exp_syn_show}
\end{figure}

\begin{figure}[h!]
\centering
\subfloat[PSNR on different blur kernels]{\includegraphics[width = 1\textwidth]{pic/psnr_kernel.png}}
\hspace{\fill}
\subfloat[PSNR on different ground-truth images]{\includegraphics[width = 1\textwidth]{pic/psnr_image.png}}
\hspace{\fill}
\subfloat[Success rate]{\includegraphics[width = 0.43\textwidth]{pic/success_rate.png}}
\hspace{\fill}
\subfloat[the 13th ground-truth image]{\includegraphics[width = 0.52\textwidth]{pic/img_13.png}}
\hspace{\fill}
\caption{Performance on Synthetic Dataset}
\label{fig:exp_syn}
\end{figure}
...
\begin{figure}[h!]
\centering
\subfloat[blurred]{\includegraphics[width = 0.24\textwidth]{pic/real/img_07.png}}\hspace{\fill}
\subfloat[$L_0$\cite{xu2013unnatural}]{\includegraphics[width = 0.24\textwidth]{pic/real/img_07_L0.png}}\hspace{\fill}
\subfloat[dark channel prior\cite{pan2016blind}]{\includegraphics[width = 0.24\textwidth]{pic/real/img_07_dark.png}}\hspace{\fill}
\subfloat[maximum saturation feature]{\includegraphics[width = 0.24\textwidth]{pic/real/img_07_max.png}}\hspace{\fill}
\\
\centering
\subfloat[blurred]{\includegraphics[width = 0.24\textwidth]{pic/real/img_03.png}}\hspace{\fill}
\subfloat[$L_0$\cite{xu2013unnatural}]{\includegraphics[width = 0.24\textwidth]{pic/real/img_03_L0.png}}\hspace{\fill}
\subfloat[dark channel prior\cite{pan2016blind}]{\includegraphics[width = 0.24\textwidth]{pic/real/img_03_dark.png}}\hspace{\fill}
\subfloat[maximum saturation feature]{\includegraphics[width = 0.24\textwidth]{pic/real/img_03_max.png}}\hspace{\fill}
\\
\centering
\subfloat[blurred]{\includegraphics[width = 0.24\textwidth]{pic/real/img_08.png}}\hspace{\fill}
\subfloat[$L_0$\cite{xu2013unnatural}]{\includegraphics[width = 0.24\textwidth]{pic/real/img_08_L0.png}}\hspace{\fill}
\subfloat[dark channel prior\cite{pan2016blind}]{\includegraphics[width = 0.24\textwidth]{pic/real/img_08_dark.png}}\hspace{\fill}
\subfloat[maximum saturation feature]{\includegraphics[width = 0.24\textwidth]{pic/real/img_08_max.png}}\hspace{\fill}
\label{fig:exp_real}
